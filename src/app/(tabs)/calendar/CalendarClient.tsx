...
export default function CalendarClient({ matches }: { matches: Match[] }) {
  ...
  return (
    <div
      className="h-full overflow-y-auto bg-[#0a0a0f]"
                  ...
                  <div key={m.id} className="bg-[#0a0a0f] rounded-xl p-4 border border-gray-800">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="flex-1 flex flex-col items-center gap-1.5">
                        <button className="active:scale-90 transition-transform" onClick={() => setTeamSheet(m.homeTeam)}>
                          <FlagImg teamId={m.homeTeam.id} fallback={m.homeTeam.flag} className="h-9" />
                        </button>
                        <span className="text-xs font-semibold text-white text-center leading-tight">{m.homeTeam.name}</span>
                      </div>
                      ...
                      <div className="flex-1 flex flex-col items-center gap-1.5">
                        <button className="active:scale-90 transition-transform" onClick={() => setTeamSheet(m.awayTeam)}>
                          <FlagImg teamId={m.awayTeam.id} fallback={m.awayTeam.flag} className="h-9" />
                        </button>
                        <span className="text-xs font-semibold text-white text-center leading-tight">{m.awayTeam.name}</span>
                      </div>
                    </div>
