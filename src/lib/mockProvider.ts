...
const knockoutMatches: Match[] = [
  ...
  { id: "sf-1", homeTeam: teams.france,   awayTeam: teams.spain,    kickoff: "2026-07-14T19:00:00Z", venue: venues.att,          round: "Semi-Finals", homeScore: 0, awayScore: 2, status: "ft" },
  { id: "sf-2", homeTeam: teams.england,  awayTeam: teams.argentina, kickoff: "2026-07-15T19:00:00Z", venue: venues.mercedesbenz, round: "Semi-Finals", homeScore: 1, awayScore: 2, status: "ft" },

  // ΓöÇΓöÇ Third Place (Jul 18) — FIFA match 103 ΓöÇΓöÇ
  { id: "3rd-1",   homeTeam: teams.france, awayTeam: teams.england,   kickoff: "2026-07-18T21:00:00Z", venue: venues.hardrock, round: "Third Place", status: "upcoming" },

  // ΓöÇΓöÇ Final (Jul 19) — MetLife Stadium, East Rutherford NJ — FIFA match 104 ΓöÇΓöÇ
  { id: "final-1", homeTeam: teams.spain,  awayTeam: teams.argentina, kickoff: "2026-07-19T19:00:00Z", venue: venues.metlife,  round: "Final",       status: "upcoming" },
]
